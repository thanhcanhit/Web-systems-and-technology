...
<div class="row">
  <div class="col col-4">
    ...
    <div class="mb-2">
      <label for="footer_email"
        >ĐĂNG KÝ NHẬN THÔNG TIN</label
      >
    </div>
    <div>
      <form action="" class="input-group">
        <input
          class="footer__mail-input form-control form-control-lg"
          type="email"
          name="footer_email"
          id="footer_email"
        ...
        />
        <button
          class="footer__mail-btn btn text-main bg-white px-4"
        >
          Đăng ký
        </button>
      </form>
  ...
  <div class="col col-2">
    <h6
      ...
      data-bs-target="#footer__col-1"
    >
      VỀ YODY
    </h6>
    <ul
      class="footer__list collapse show"
      id="footer__col-1"
    >
  ...
  <div class="col col-3">
    ...
    >
      ...
      <li class="footer__item">
        ...
        >
        <a href="" class="footer__link"
          >Thắc mắc đơn hàng: 024 999 86 999</a
        >
        <a href="" class="footer__link"
    ...
    <div>
      <a
        href="https://www.dmca.com/Protection/Status.aspx?ID=d3a2c2c5-a581-451b-b7ff-ff08fee58d6a&refurl=https://yody.vn/flash-sale"
        ><img
          src="./assets/img/shared/footer/logo_bct.png"
          alt="Logo bộ công thương"
      /></a>
      <a
        href="http://online.gov.vn/Home/WebDetails/44085?AspxAutoDetectCookieSupport=1"
        ><img
          src="./assets/img/shared/footer/_dmca_premi_badge_5.png"
          alt="DMCA PROTECTED"
      /></a>
    </div>
  </div>
