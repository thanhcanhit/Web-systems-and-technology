			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col col-8">
					<nav class="navbar">
						<ul class="navbar-nav d-flex flex-row gap-3">
							...
							<li class="nav-item">
								<a class="nav-link fw-semibold text-14 text-blue text-hover-main" href="#">Danh mục</a>
							...
							<li class="nav-item">
								<a class="nav-link fw-semibold text-14 text-blue text-hover-main" href="#">Đồng phục</a>
							</li>
							<li class="nav-item">
				...
				<div class="cart-sign-block col col-4 d-flex gap-4 align-items-center fw-semibold">
					<div class="cart d-flex align-items-center gap-2 ms-auto">
						...
						<a href="/cart" class="header__link text-hover-main"><span>GIỎ HÀNG</span></a>
						<div class="cart__content">
							<div class="cart__empty">
								<img src="/assets/img/shared/header/blank_cart.svg" alt="" />
