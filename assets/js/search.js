...
$(async () => {
	...
	$("#content").html(
		filterData.length == 0
			? `
    <div class="empty w-75 mx-auto d-flex justify-content-center flex-column align-items-center">
      <img src="/assets/img/search/search-page.svg" width="100" alt="">
      ...
      <ul class="d-flex flex-column align-items-center gap-0">
        <li>
